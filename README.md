...
В проекте присутствует файл `data.sql`, который автоматически заполняет базу данных тестовыми данными при запуске приложения.

В базу добавляются:

- преподаватели;
- классы;
- расписание занятий на 5 учебных дней. 

## 5. Api эндпоинты с примерами
